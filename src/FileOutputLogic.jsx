...
const FileOutputLogic = (props) => {
  ...
  const NewFiles = () => {
    let Z = props.ContentTarget.current.value;

    console.log(props.ContentTarget.current.value);
    const Function1 = () => {
      F = Z.replaceAll(`["age":0,"direction":0]`, "0")
        .replaceAll(`["age":0]`, "0")
    ...
    const Function2 = () => {
      F = F.replaceAll(`["monster_egg_stone_type":"stone"]`, "0")
        .replaceAll(
        ...
        .replaceAll(`["new_log_type":"dark_oak","pillar_axis":"y"]`, "0")
